...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _assemblyscript_loader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @assemblyscript/loader */ \"./node_modules/@assemblyscript/loader/index.js\");\n/* harmony import */ var _benchmark__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./benchmark */ \"./src/benchmark.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n/** App */\n//import WASMWorker from './wasm_worker';\n\n\n\nvar App = /*#__PURE__*/function () {\n  function App() {\n    var _this = this;\n\n    _classCallCheck(this, App);\n\n    // worker\n    // let w = new WASMWorker();\n    // WebAssembly.instantiateStreaming(fetch('./build/app.wasm'), {})\n    // .then(res => { console.log(res); });\n    var wasmSource = 'build/out.wasm';\n    console.log('Loading:', wasmSource);\n    fetch(wasmSource).then(function (res) {\n      return res.arrayBuffer();\n    }).then(function (bytes) {\n      return _assemblyscript_loader__WEBPACK_IMPORTED_MODULE_0__[\"default\"].instantiate(bytes, {});\n    }).then(function (res) {\n      _this.asm = res.exports;\n\n      _this.bench();\n    });\n  }\n\n  _createClass(App, [{\n    key: \"runBenchmark\",\n    value: function runBenchmark(callback, iter) {\n      return new Promise(function (resolve, reject) {\n        var i = 0;\n\n        while (i++ < iter) {\n          callback;\n        }\n\n        resolve(performance.now());\n      });\n    }\n  }, {\n    key: \"bench\",\n    value: function bench() {\n      var benchJS = function benchJS() {\n        var sum = 0;\n\n        for (var i = 0; i < 100000; i++) {\n          sum += Math.random() * Math.random();\n        }\n\n        return 0;\n      };\n\n      var benchASM = this.asm.bench; // run benchmark\n\n      var benchmark = new _benchmark__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n      benchmark.add('ASM', function () {\n        benchASM();\n      });\n      benchmark.add('JS', function () {\n        benchJS();\n      });\n      benchmark.run();\n    }\n  }]);\n\n  return App;\n}();\n\nwindow.addEventListener('load', function () {\n  var app = new App();\n});\n\n//# sourceURL=webpack://XWSM/./src/app.js?");
